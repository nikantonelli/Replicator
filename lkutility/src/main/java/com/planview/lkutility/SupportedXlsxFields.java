...
public class SupportedXlsxFields {
	...
	public class Modifiable {
		...
		/**
		 * public PlanningIncrement[] planningIncrements; //Trouble with these is how do you identify when trying to import????
		 * Because there could be many sub-increments of the same name (e.g. Iteration 1), you are going to have to traverse the 
		 * whole planning increment tree upwards
		 */
